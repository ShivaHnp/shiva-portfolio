    ...
    return(
        <section id="about" className="bg-bg-alt border-y border-line py-24">
            <div className="mx-auto max-w-6xl px-5 grid md:grid-cols-[0.8fr_1.2fr] gap-16">
                <div className="max-w-[260px] bg-accent-soft aspect-[4.5] flex items-center justify-center text-accent-deep font-mono text-4xl font-bold font-bold rpounded-lg">
                    s.h
                </div>
                <div>
                    ...
                    <p className="text-ink-soft mb-4">I'm a frontend developer based in Milan, Italy. I did my master in Politecnico di Milano, whre I built a solid foundation in how designs actually work - not just hop it looks.</p>
                    <p className="border-l-2 border-accent-deep pl-4 my-6 text-xl">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</p>
